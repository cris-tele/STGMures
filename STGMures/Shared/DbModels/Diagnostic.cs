...
public partial class Diagnostic
{
    ...
    /// <summary>
    /// Min alert value (normal values between min and max); 
    /// </summary>
    public string MinAlertValue { get; set; }

    /// <summary>
    /// Max alert value (normal values between min and max)
    /// </summary>
    ...
    public virtual DiagnosticCategory DiagnosticCategory { get; set; }
